...
enum RTSPLowerTransport {
    ...
    RTSP_LOWER_TRANSPORT_ASYNC_TCP,
...
typedef struct RTSPState {
    ...
    /**
     * RTSP PLAY command 'Rate-Control: on/off' header
     */
    int play_rate_control;

    /**
     * RTSP PLAY command 'Scale: 1.0' header
     */
    float play_scale;

    /**
     * RTSP PLAY command additional headers string
     */
    char* play_headers;
