...
class keyboard_event_stream : public vxg::cloud::agent::event_stream {
    static constexpr char* TAG = "kbd-event-stream";
    static constexpr char* KEYBOARD_COMMAND_M = "m";
    static constexpr char* KEYBOARD_COMMAND_M_VXG_EVENT = "keyboard-cmd-m";
    ...
    void _toggle_mapping_state_by_cmd(const std::string& cmd) {
        ...
        if (_mapping != mappings_.end()) {
            ...
            if (_mapping->second.vxg_event_conf.caps.statefull)
    ...
    static vxg::cloud::agent::proto::event_object _event_from_mapping(
        ...
        result.active = mapping.vxg_event_conf.caps.statefull && mapping.state;
