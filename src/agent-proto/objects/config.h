...
struct event_object {
    ...
    // struct WifiInfo {
    //     NLOHMANN_DEFINE_TYPE_INTRUSIVE(WifiInfo);
    // };
...
private:
    ...
    friend void to_json(json& j, const event_object& c) {
        ...
        switch (c.event) {
            ...
            // break;
            // // “record” CM informs server about necessity of changing of
            // recording state case ET_RECORD:
            //     j.update({{"record_info", c.record_info}});
            // break;
            // // “memorycard” camera's memory-card status change
            // // “wifi” status of camera's currently used Wi-Fi
